 ...
 * @date 12/2025
 *
 * Iconos SVG minimalistas para mejorar la UI sin usar emojis.
...
export const SettingsIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 1v6m0 6v6m5.196-14.804l-4.243 4.243m0 6.364l4.243 4.243M1 12h6m6 0h6M6.804 6.804l4.243 4.243m0 6.364l-4.243 4.243"></path>
  </svg>
);
